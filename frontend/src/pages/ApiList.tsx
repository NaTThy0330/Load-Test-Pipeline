      ...
      <div className="max-w-7xl mx-auto px-6 py-16">
        ...
        <div className="p-8 rounded-2xl bg-gradient-to-br from-blue-500/10 to-purple-500/10 border border-blue-500/30 backdrop-blur-xl mb-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div>
              <div className="text-sm text-gray-400 mb-2">Total APIs Detected</div>
              <div className="text-4xl font-bold text-white">{apis.length}</div>
            </div>
            <div>
              <div className="text-sm text-gray-400 mb-2">APIs Selected</div>
              <div className="text-4xl font-bold bg-gradient-to-r from-blue-400 to-purple-400 bg-clip-text text-transparent">
                {selectedApis.length}
              </div>
            </div>
            <div>
              <div className="text-sm text-gray-400 mb-2">Unique Domains</div>
        ...
        <div className="flex items-center gap-4 mb-6">
          <div className="flex-1 relative">
            ...
            <Input
              ...
              className="pl-12 bg-gray-900/50 border-white/10 text-white placeholder:text-gray-500 h-12"
            />
          </div>
          <Button
            onClick={toggleAll}
            variant="outline"
            className="border-white/10 bg-white/5 text-white hover:bg-white/10 h-12"
          >
            ...
            >
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="mb-2">
                    <code className="text-sm text-white font-mono break-all">{api.name}</code>
                  </div>
